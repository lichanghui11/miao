class Conway {
  constructor(width = 10, height = 10) {
    this.width = width;
    this.height = height;
    this.world = new Array(this.height).fill(0).map(it => new Array(this.width).fill(0));
    this.alive();
  }
  ...
  next() {
    let newWorld = new Array(this.height).fill(0).map(it => new Array(this.width).fill(0))
...
let game = new Conway(15, 15);
container.innerHTML = game.renderInfo();
